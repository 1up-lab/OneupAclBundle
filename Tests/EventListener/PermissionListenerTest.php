...
class PermissionListenerTest extends AbstractSecurityTest
{
    ...
    {
        $object = new SomeObject(1);
        $this->manager->grantObjectPermission($object, $this->getToken(), MaskBuilder::MASK_VIEW);
    ...
    public function testMultiplePermissionInSingleAnnotation()
    {
        ...
        $this->manager->grantObjectPermission($object1, $this->getToken(), MaskBuilder::MASK_VIEW);
        $this->manager->grantObjectPermission($object2, $this->getToken(), MaskBuilder::MASK_VIEW);
